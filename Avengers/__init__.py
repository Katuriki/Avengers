...
from Avengers.config import get_bool_key, get_int_key, get_list_key, get_str_key
from Avengers.utils.logger import log
from Avengers.versions import AVENGERS_VERSION

log.info("----------------------")
log.info("|    Avengers      |")
log.info("----------------------")
log.info("Version: " + AVENGERS_VERSION)

if get_bool_key("DEBUG_MODE") is True:
    AVENGERS_VERSION += "-debug"
