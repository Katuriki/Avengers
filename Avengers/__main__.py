...
from Avengers import TOKEN, bot, dp
from Avengers.config import get_bool_key, get_list_key
from Avengers.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
from Avengers.utils.logger import log
...
import_module("Avengers.modules.pm_menu")
# Import misc stuff
import_module("DaisyX.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("Avengers.utils.sentry")
