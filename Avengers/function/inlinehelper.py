...
from Avengers import BOT_USERNAME, OWNER_ID
from Avengers.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from Avengers.function.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/Avengersbot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Avengers✨](https://github.com/4545):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/AKCRAZYTECH_BOT)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
