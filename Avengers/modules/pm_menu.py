...
# Copyright (C) 2021 TeamAvengers
# Copyright (C) 2020 Inuka Asith

# This file is part of Avengers (Telegram Bot)
...
from Avengers.decorator import register
from Avengers.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/TeamAvengers/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/AvengersUpdates"),
        InlineKeyboardButton(
    ...
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add Avengers to your group",
            url=f"https://telegram.me/Avengersbot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/AvengersBOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
