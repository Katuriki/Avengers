...
from Avengers.services.mongo import db
from Avengers.services.redis import redis
...
for filename in os.listdir("Avengers/localization"):
    log.debug("Loading language file " + filename)
    with open("Avengers/localization/" + filename, "r", encoding="utf8") as f:
